...
const InspireColorLibrary3D = dynamic(
  () => import("./InspireColorLibrary3D"),
  {
    ssr: false,
    loading: () => (
      <div className="inspire-style-library-fallback">
        Loading 3D library...
      </div>
    ),
  }
...
export default function InspireStyleEditor({
  ...
  const libraryColors = useMemo(() => {
    const source = displayPalette.length ? displayPalette : FALLBACK_PALETTE;
    return Array.from({ length: libraryCount }, (_, index) => {
      ...
      <div className="inspire-style-top">
        <div className="inspire-style-top-grid">
          <div className="inspire-style-panel">
            ...
            >
              <InspireColorLibrary3D colors={libraryColors} />
            </div>
          </div>
          <div className="inspire-style-middle">
            ...
            <div className="inspire-style-placeholders">
              <div className="inspire-style-placeholder">Placeholder block</div>
              <div className="inspire-style-placeholder">Placeholder block</div>
              <div className="inspire-style-placeholder">Placeholder block</div>
              <div className="inspire-style-placeholder">Placeholder block</div>
            </div>
