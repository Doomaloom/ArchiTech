...
export default function IterateView() {
  ...
  return (
    <div className="imageflow-iteration" ref={refs.iterationRef}>
      <div className="imageflow-iteration-preview" ref={refs.iterationPreviewRef}>
        <div
        ...
        {derived.canBoxSelect ? (
          <Selecto
            ...
            selectableTargets={[
              ".imageflow-iteration-site [data-gem-id]:not(.is-layer-hidden)",
            ]}
            hitRate={0}
            selectByClick={false}
      ...
      {state.showLayers ? (
        <IterationLayersPanel
          layerEntries={derived.layerEntries}
